...
Aufgabe 2 unten bittet euch, genau diesen Angriff gegen das `SerperDevTool` des `researcher`-Agenten zu konstruieren — ein hypothetisches bösartiges *Suchergebnis* statt eines direkten Prompts an das Modell.
