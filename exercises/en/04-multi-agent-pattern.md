...
CrewAI's hierarchical process with a `manager_llm` plays the role of the "hierarchical chat" pattern: a coordinating agent decides who talks/acts next, instead of you fixing the order yourself.
